...
<!-- <div class="container"> -->
  ...
  <div class="panel-body">
   <form:form action="cargar-hospedaje"  method="POST" modelAttribute="hospedaje">
		...
		<div class="form-group">
			<label for="ubicacion">Ubicación del hospedaje:</label>
			...
			<input type="text" class="form-control" name="precio" id="precio">
				...
				<div class="form-group">
                    <input name="img1" id="img1" type="file" class="file"  data-preview-file-type="any" required>
                </div>
                
                <div class="form-group">
                    <input name="img2" id="img2" type="file" class="file" data-preview-file-type="any" required>
                </div>
                
                <div class="form-group">
                    <input name="img3" id="img3" type="file" class="file"  data-preview-file-type="any" required>
                </div>
