...
<!-- menu que el usuario al logearse -->
	<%@ include file="header.jsp" %>
		...
		<form:form action="registrar-usuario" method="POST" modelAttribute="usuario" onSubmit="return compararContraseña()">
			<div class="col-lg-4">
  			...
  			<div class="form-group">
    			 ...
    			 <input type="text" class="form-control" name="apellido" id="apellido"></input>
  			</div>
  			</div>
  			...
  			<div class="col-lg-6">
   			<div class="form-group">
    			...
    			<input type="password" class="form-control" name="rpassword" id="rpassword"></input>
  			</div>
  			</div>
